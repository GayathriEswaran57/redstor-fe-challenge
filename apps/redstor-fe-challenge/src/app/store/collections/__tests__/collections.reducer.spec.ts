...
describe('Collections Reducer', () => {
  ...
  it('should update collections and collectionInTotal on loadCollectionsSuccess', () => {
    const mockCollections: ICollection[] = [collectionMock];

    const result = reducer(initialState, CollectionsActions.loadCollectionsSuccess(mockCollections, mockCollections.length));
